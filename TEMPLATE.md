...
Since then I pushed **{{ COMMITS }}** commits, submitted **{{ PULL_REQUESTS }}** pull requests, created **{{ REPOSITORIES }}** personal projects and contributed to **{{ REPOSITORIES_CONTRIBUTED_TO }}** external repositories.
